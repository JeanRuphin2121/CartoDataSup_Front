...
const FormationsRepartionGeo = () => {
  ...
  useEffect(() => {
    fetchStats();
  }, [filters.formation_searched, filters.repartition_geo_sector, filters.annee, filters.academy, filters.departement, filters.commune, filters.region, filters.status_institution, filters.etablissement,  filters.formation_selectivity, filters.formation]);
