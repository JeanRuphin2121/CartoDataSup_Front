...
const FormationsFillingRate = () => {
  ...
  const fetchStats = async () => {
    try {
        ...
        const response = await axios.get(API_BASE_URL + "formations/stats/?tri=filling_rate", 
            {
                params: filters,
                headers: {
  ...
  const dataAdmissions = {
    ...
    datasets: [
      ...
      },
      {
        ...
        data: data.map(item => item.filling_rate),
      ...
      <div className="container-fluid">
        <div className="row mb-2">
          <div className="col-sm-6">
            <h1 className="m-0">Taux de remplissage</h1>
            <p className="m-0">Combien d'admis par rapport à la capacité d'accueil</p>
          </div>
          <div className="col-sm-6">
            <ol className="breadcrumb float-sm-right">
              <li className="breadcrumb-item"><a href="/public-vs-private">Accueil</a></li>
              <li className="breadcrumb-item active">Taux de remplissage</li>
            </ol>
          </div>
        </div>
      </div>
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-12">
            ...
            <div className="card card-info">
              <div className="card-header">
                <h3 className="card-title">Taux de remplissage</h3>
...
export default FormationsFillingRate;
